...
public:
	...
	virtual void update(float dt) override
	{
        for (auto ent : _entities->getEntities())
        {
            ...
            {
                auto& physicsAnimator = ent.getComponent<CPhysicsAnimator>();
                auto& body = ent.getComponent<CPhysicsBody>();
                auto& animComp = ent.getComponent<CAnimation>();
                auto& spriteComp = ent.getComponent<CSprite>();
